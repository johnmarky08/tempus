<script>
    import Layout from "./Componenets/Layout.svelte";
                        ...
                        >
                            ...
                            >
                                <img
                                    ...
                                    data-sr-delay="200"
                                    src=""
                                    alt="Main dashboard illustration placeholder"
            ...
            >
                ...
                >
                        ...
                        <div class="flex flex-col gap-5">
                            ...
                            <div class="flex items-center pt-1">
                                ...
                                >
                                    ...
                                    <img
                                        src=""
                                        alt="Open description icon placeholder"
                                        class="h-4 w-4 shrink-0"
                                    />
                                </button>
                            </div>
                    ...
                    >
                        <div class="flex flex-col gap-5">
                            ...
                            >
                                {#each data.techStack as { img, name, description, alt, color, textColor }, i}
                                    <div
                                        data-sr
                                    ...
                                    >
                                        <img
                                            ...
                                            src={img}
                                            {alt}
                                            class="group-hover:scale-125 h-12 w-12 rounded-full bg-white/5 object-cover transition-all duration-300"
                                        />
                ...
                >
                    ...
                    <div class="grid w-full gap-16 md:grid-cols-3">
                        {#each data.dev as { img, name, alt, socials }, i}
                            <div
                                data-sr
                                data-sr-delay={i * 140}
                     ...
                     after:bg-[#6FB8E7]
                       ...
                       group-hover:after:w-full"
                                ...
                                >
                                    {#each socials as { img, link, alt }, j}
                                        <div
                                            data-sr
