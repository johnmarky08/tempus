                            ...
                            <div data-sr class="relative w-full">
                                ...
                                >
                                    ...
                                    <div
                                        ...
                                        style="left: calc({exertionPercent}% - 14px); transition: left .18s ease;"
                                    >
                                        <div
                                ...
                                <div
                                    class="flex justify-between text-xs text-slate-400 mt-3 tracking-widest px-1"
                                >
                                    {#each Array.from({ length: 11 }, (_, index) => index) as tick}
                                        <span class="text-base">{tick}</span>
                                    {/each}
                                </div>
                            </div>
                        </div>
