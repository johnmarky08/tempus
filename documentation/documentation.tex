...
\begin{titlepage}
    ...
    {\Large \textbf{ALGORITHM-BASED INTELLIGENT SYSTEM APPLICATION}}\\[1cm]
    ...
    Mr. Anthony Dorado\\
    Ms. Dorothy Mei Cabuyao\\
    Ms. Kristine Kaye Arida\\[2cm]
...
\noindent\textit{Implementation Notes:} See \texttt{random-forest-regressor.py} and \texttt{db\_utils.py}.
...
\noindent\textbf{Training and Preprocessing.}
\begin{itemize}
    \item Data source: labeled safety-assessment records seeded via Safety Assessment Seeder and augmented with environmental observations.
...
\begin{itemize}
    \item The UI is implemented as a Svelte single-page application with page-level components under \texttt{resources/pages/} such as \texttt{Home}, \texttt{FuelPrice}, \texttt{HeatIndex}, and \texttt{History}.
...
\begin{figure}[p]
    \centering
    \includegraphics[width=0.7\textwidth]{images/about.jpg}
    \caption{About Page}
...
\begin{figure}[p]
    \centering
    \includegraphics[width=0.7\textwidth]{images/devs.jpg}
    \caption{About Page - Developers Info}
    \label{fig:about_page_devs}
\end{figure}

\begin{figure}[p]
    \centering
    \includegraphics[width=0.7\textwidth]{images/fuel_price_module.jpg}
    \caption{Fuel Price Module - Graphs and Predictions}
    \label{fig:fuel_price_module}
\end{figure}

\begin{figure}[p]
    \centering
    \includegraphics[width=0.7\textwidth]{images/heat_index_assessment.jpg}
    \caption{Heat Index Module - Assessment}
    \label{fig:heat_index_assessment}
\end{figure}

\begin{figure}[p]
    \centering
    \includegraphics[width=0.7\textwidth]{images/heat_index_forecasts.jpg}
    \caption{Heat Index Module - 7 Hours Forecasts}
    \label{fig:heat_index_forecasts}
\end{figure}

\begin{figure}[p]
    \centering
    \includegraphics[width=0.7\textwidth]{images/heat_index_module.jpg}
    \caption{Heat Index Module - Current Data}
    \label{fig:heat_index_module}
\end{figure}

\begin{figure}[p]
    \centering
    \includegraphics[width=0.7\textwidth]{images/fuel_price_history.jpg}
    \caption{History Module - Fuel Price Data}
    \label{fig:fuel_price_history}
\end{figure}

\begin{figure}[p]
    \centering
    \includegraphics[width=0.7\textwidth]{images/heat_index_history.jpg}
    \caption{History Module - Heat Index Data}
    \label{fig:heat_index_history}
\end{figure}

\begin{figure}[p]
    \centering
    \includegraphics[width=0.7\textwidth]{images/faqs.jpg}
    \caption{FAQ's Static Chat-bot}
    \label{fig:faqs}
\end{figure}

\begin{figure}[p]
    \centering
    \includegraphics[width=0.7\textwidth]{images/footer.jpg}
    \caption{Footer Component}
    \label{fig:footer_component}
\end{figure}

\begin{figure}[p]
    \centering
    \includegraphics[width=0.7\textwidth]{images/loading.jpg}
    \caption{Loading Component}
    \label{fig:loading_component}
\end{figure}

\begin{figure}[p]
    \centering
    \includegraphics[width=0.7\textwidth]{images/light_mode.jpg}
    \caption{Light Mode}
...
\begin{figure}[p]
    \centering
    \includegraphics[width=0.4\textwidth]{images/mobile_view.jpg}
    \caption{Mobile View (Responsiveness)}
...
The results were verified from the frontend pages of the system, mainly \texttt{FuelPrice}, \texttt{HeatIndex}, and \texttt{History}. These pages show the actual user-facing outputs of the backend and machine-learning modules, including forecast cards, heat-safety labels, charts, and searchable history tables. The system behaves as expected when the input data is complete and the frontend receives valid JSON from the Laravel controllers and Python bridge.
...
& The History page filters rows through searchHistory rows, then sorts them through sortHistory rows, and only the matching entries remain visible in the table.
